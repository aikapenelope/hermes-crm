...
{#if open}
	...
	>
		...
		<!-- Dialog — pure black terminal style -->
		<div
			class="relative w-full max-w-sm border border-[#1a1a1a] bg-[#080808] p-6 shadow-2xl overflow-hidden"
			role="dialog"
			aria-modal="true"
		...
		>
			...
			<div class="mb-1 text-[9px] tracking-widest text-[#444] uppercase">CONFIRMAR.ACCIÓN</div>
